...
// tries to autocomplete the approach and returns the completed version
...
// append the names of all executable files and directories
// at the specified path to the list
void append_binaries_to_list(char* path, char*** name_list,
                                int* name_list_length, int* name_list_index);

// appends the naems of all builtin utilities to the list
void append_builtin_utilities_to_list(char*** name_list, int* name_list_length,
                                        int* name_list_index);
